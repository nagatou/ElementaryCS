...
\framesubtitle{while 文とfor 文}
  \begin{itemize}
\item 特定の実行列を繰り返し実行
\item \hyperlink{mult}{\beamerbutton{Jump to an example of while}}
\item 詳細は \href{https://docs.python.org/ja/3/reference/index.html}{\beamerbutton{Python ドキュメント 8.2, 8.3 節}}参照
  \end{itemize}
...
\item \hyperlink{gcd}{\beamerbutton{Jump to an example of if}}
\item 詳細は \href{https://docs.python.org/ja/3/reference/index.html}{\beamerbutton{Python ドキュメント 8.1 節}}参照
\item 条件式は \href{https://docs.python.org/ja/3/reference/index.html}{\beamerbutton{Python ドキュメント 6.10, 6.11, 6.12 節}}参照
  \end{itemize}
\end{frame}
%%%
% Homework 1
