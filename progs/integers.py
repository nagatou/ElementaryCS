...
# この関係を整数の大小関係と呼ぶ．
# 以下の関数 comp_on_int では za < zb のとき 1 を返し，そうでないとき 0 を返すようにする．
def comp_on_int (za,zb):
  return(comp_on_nat(add_on_nat(za[0],zb[1]),add_on_nat(za[1],zb[0])))
#(4) 4 点
# inverse_on_int は z の逆元を求める関数．逆元とは，加法に関する単位元 [0,0] として，(a,b)+(a',b')=(a',b')+(a,b)=(n,n) となるような (a',b') のことを (a,b) の加法に関する逆元という．
# 逆元がわかれば減算は逆元を足せばいい．
